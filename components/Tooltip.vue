...
const { class: mainClass, root, provider, content } = defineProps<{
  class?: ClassValue
...
const providerProps = computed<TooltipProviderProps>(() => ({ delayDuration: 300, ...provider }))
const contentProps = computed<TooltipContentProps>(() => ({ sideOffset: 4, ...content }))
