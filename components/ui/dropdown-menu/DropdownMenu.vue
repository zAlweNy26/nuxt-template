...
import {
	DropdownMenuContent, type DropdownMenuContentProps, DropdownMenuPortal, DropdownMenuRoot, type DropdownMenuRootEmits,
	type DropdownMenuRootProps, DropdownMenuTrigger, useForwardPropsEmits,
} from 'radix-vue'
...
<template>
	<DropdownMenuRoot v-bind="forwardedRoot">
		...
		<DropdownMenuPortal v-if="$slots.content">
			<DropdownMenuContent v-bind="contentProps" :class="cn(
